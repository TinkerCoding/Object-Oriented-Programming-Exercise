...
SuperHero.prototype.saveKittens = function (number) {
    ...
    if (energyLevel <= 0) {
        ...
        console.log("cost hime 10% of his energy, bringing him down to " + energyLevel + "% power");
    }
};
...
SuperHero.allInstances = []; // creating an array so that any time a new instances of a Superhero is created, I can target all for QUnit checks.
...
//V2
siperman.faceOff(flash);

//V3
//tests added in test.js
